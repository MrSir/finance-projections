...
class HomeController extends Controller
{
    public function index()
    {
        ...
        $once_transactions = Transaction::where('frequency','=','once')->get();
        $weekly_transactions = Transaction::where('frequency','=','weekly')->get();
        $biweekly_transactions = Transaction::where('frequency','=','biweekly')->get();
        $monthly_transactions = Transaction::where('frequency','=','monthly')->get();
        $annual_transactions = Transaction::where('frequency','=','annual')->get();


        $transactions = [
            'once' => $once_transactions,
            'weekly' => $weekly_transactions,
            'biweekly' => $biweekly_transactions,
