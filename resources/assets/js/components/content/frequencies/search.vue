<template>
    <div id="frequenciesSearchTemplate" class="box box-info">
        ...
        <div class="box-footer">
            <button type="button" class="btn btn-primary" v-on:click="searchFrequencies">Search</button>
            <button type="button" class="btn btn-info" v-on:click="resetSearchFrequencies">Reset</button>
        </div>
    </div>
</template>
