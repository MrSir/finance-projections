...
class SearchTest extends IndexSearch
{
     ...
     * @group App.Pipes.Transaction.Frequency.Index.Search
     * @group App.Pipes.Transaction.Frequency.Index.Search.Success
     */
     ...
     * @group App.Pipes.Transaction.Frequency.Index.Search
     * @group App.Pipes.Transaction.Frequency.Index.Search.Success
     * @group App.Pipes.Transaction.Frequency.Index.Search.Success.Name
     */
     ...
     * @group App.Pipes.Transaction.Frequency.Index.Search
     * @group App.Pipes.Transaction.Frequency.Index.Search.Success
     * @group App.Pipes.Transaction.Frequency.Index.Search.Success.Description
     */
     ...
     * @group                    App.Pipes.Transaction.Frequency.Index
     * @group                    App.Pipes.Transaction.Frequency.Index.Search
     * @group                    App.Pipes.Transaction.Frequency.Index.Search.Failure
     * @expectedExceptionCode    500
     * @expectedException Exception
     * @expectedExceptionMessage Frequency search failed.
     */
